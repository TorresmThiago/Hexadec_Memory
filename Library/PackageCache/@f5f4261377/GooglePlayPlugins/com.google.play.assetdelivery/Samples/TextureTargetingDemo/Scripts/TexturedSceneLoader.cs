...
namespace Google.Play.AssetDelivery.Samples.TextureTargetingDemo.Scripts
{
    /// <summary>
    /// Trigger the download and loading of an AssetBundle containing a scene
    /// and another one containing textures. When done, load the
    /// scene.
    /// </summary>
    public class TexturedSceneLoader : MonoBehaviour
    {
        void Start()
        {
